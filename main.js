...
function attachEventListeners() {
    ...
    document.querySelectorAll('.copy-code-btn').forEach(button => { button.onclick = () => navigator.clipboard.writeText(state.family.code).then(() => showToast('Código copiado!', 'success')); });
