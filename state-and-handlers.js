...
function runDashboardTutorial(driver) {
  const tour = driver({
    ...
    steps: [
      {
        element: "#family-info-button",
        popover: {
          title: "Sua Família 🏡",
          description:
            "Clique aqui para ver o código de convite, gerenciar membros e configurações da família.",
        },
      },
      {
        element: '.nav-tab[data-view="dashboard"]',
        popover: {
          title: "Dashboard 📊",
          description:
            "Visão geral do saldo, receitas e despesas do mês atual.",
        },
      },
      {
        element: '.nav-tab[data-view="records"]',
        popover: {
          title: "Registros 📝",
          description: "Adicione e filtre todas as receitas e despesas aqui.",
        },
      },
      {
        element: '.nav-tab[data-view="budget"]',
        popover: {
          title: "Orçamentos 💰",
          description: "Defina limites de gastos para cada categoria.",
        },
      },
      {
        element: '.nav-tab[data-view="debts"]',
        popover: {
          title: "Dívidas e Parcelas 💳",
          description: "Controle empréstimos e compras parceladas no cartão.",
        },
      },
      {
        element: '.nav-tab[data-view="goals"]',
        popover: {
          title: "Metas 🚀",
          description:
            "Crie cofrinhos para guardar dinheiro para sonhos futuros.",
        },
      },
      {
        ...
        popover: {
          title: "Seu Perfil 👤",
          description:
            "Acesse suas configurações ou refaça este tutorial aqui.",
        },
      },
    ],
    onDestroyStarted: () => {
    ...
    steps: [
      {
        ...
        popover: {
          ...
          description:
            "Comece aqui se você quer criar um novo grupo financeiro do zero e convidar pessoas.",
        },
      },
      {
        ...
        popover: {
          ...
          description:
            "Se alguém já te mandou um código, cole ele aqui para entrar no grupo existente.",
        },
      },
      {
        element: "#user-menu-button",
...
export function checkAndStartTutorial() {
  ...
  setTimeout(() => {
    ...
    if (
      state.currentView === "dashboard" &&
      !localStorage.getItem("greenhive_dashboard_tutorial_seen")
    ) {
      runDashboardTutorial(driverObj);
    } else if (
      state.currentView === "onboarding" &&
      !localStorage.getItem("greenhive_onboarding_tutorial_seen")
    ) {
      runOnboardingTutorial(driverObj);
    }
  }, 1500);
